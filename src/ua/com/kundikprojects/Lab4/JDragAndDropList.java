package ua.com.kundikprojects.Lab4;
...
public class JDragAndDropList extends JFrame {
    private JDragAndDropList() {
        super("Drag and drop List");
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(JDragAndDropList::new);
        EventQueue.invokeLater(JDragAndDropList::new);
    }
}
